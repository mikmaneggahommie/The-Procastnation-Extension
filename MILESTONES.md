...
| :----------- | :-------------------------------------- | :------------ | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Feb 11, 2026 | **Fix: Source Authority (Reminders)**   | `HEAD`        | Definitive fix for "Once" reminder timing. Implemented Source Authority pattern: `trackLaunch` (0-time awareness) is forbidden from initializing Time Reminders. Only `trackUsage` (authoritative time) can establish baselines. Fixes "0-baseline" bug. |
