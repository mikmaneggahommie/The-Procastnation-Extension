...
| :----------- | :----------------------------------- | :--------------------------- | :------------------------------------------------------------------------------------------------------------------------------------ |
| Feb 4, 2026  | **Feat: Robust UI & Discard Logic**  | HEAD                         | Standardized Error Messages; Smart Shortcut Normalization; Unified simplified display; Fixed Discard flow (data revert + UI refresh). |
